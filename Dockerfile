...
COPY index.html main.js climate.js geography.js biomes.js astro.js style.css /usr/share/nginx/html/
COPY data/elevation.json data/elevation.bin data/rivers.json /usr/share/nginx/html/data/
